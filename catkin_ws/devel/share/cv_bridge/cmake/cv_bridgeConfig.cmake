...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/tucuman/catkin_ws/src/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/tucuman/catkin_ws/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/tucuman/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tucuman/catkin_ws/src/cv_bridge/${idir}'.  ${_report}")
    endif()
